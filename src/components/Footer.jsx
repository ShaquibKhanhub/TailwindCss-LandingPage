...
const Footer = () => {
  return (
    <div className="w-full bg-white py-24">
      <div className="custom-col-span md:max-w-[1480px] m-auto grid md:grid-cols-5  gap-8 max-w-[600px]  px-4 md:px-0">
        <div className=" col-span-2">
          <img className="h-[25px]" src={logo} alt="" />
          <h1 className="text-2xl font-bold mt-10">Contacct Us</h1>
          ...
          <div className="flex gap-4 py-4">
            <div className="p-4 bg-[#E9F8F3] rounded-xl">
              <FaFacebookF size={25} color="#4DC39E" />
            </div>
            <div className="p-4 bg-[#E9F8F3] rounded-xl">
        ...
        <div className="custom-col-span">
          ...
          <form className="py-4">
            ...
            />
            <button className="max-w-[780px] w-full my-4 px-5 py-3 rounded-md bg-[#20B486] text-white font-medium md:w-auto md:max-w-none">
              Subscribe Now
            </button>
          </form>
        </div>
